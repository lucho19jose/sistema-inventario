                            ...
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input v-model="search" v-on:keyup.enter="getInputs(1, search, criterion)" type="text" class="form-control bg-light shadow-sm" placeholder="Entrada de producto a buscar">
